module iso_c_const
  ...
  enum, bind(c)
   enumerator :: c_int = 4, c_short = 2, c_long = 8, c_long_long = 8
  end enum

  enum, bind(c)
   enumerator :: c_signed_char = 1, c_size_t = 8
  end enum

  enum, bind(c)
   enumerator :: c_int8_t = 1, c_int16_t = 2, c_int32_t = 4, c_int64_t = 8
   enumerator :: c_int8_t = 1, c_int16_t = 2, c_int32_t = 4, c_int64_t = 8
   enumerator :: c_int_least8_t = 1, c_int_least16_t = 2, c_int_least32_t = 4, c_int_least64_t = 8
   enumerator :: c_int_fast8_t = 1, c_int_fast16_t = 2, c_int_fast32_t = 4, c_int_fast64_t = 8
  end enum

  enum, bind(c)
   enumerator :: c_intmax_t = 8
   enumarator :: c_intptr_t = 8, c_ptrdiff_t = 8
  end enum

  enum, bind(c)
   enumerator :: c_float = 4, c_double = 8, c_double_complex = 8
   enumerator :: c_long_double = -1, c_long_double_complex = -1
  end enum

  enum, bind(c)
   enumerator :: c_bool = 1, c_char = 1
  end enum
